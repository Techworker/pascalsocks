 ...
 * successful.
 */
class UnsubscribeSuccess extends AbstractEvent {
  /**
  ...
  constructor(subscription) {
    super(`Unsubscribed from subscriptions ${subscription.ident} (event = ${subscription.event})`);
...
module.exports = UnsubscribeSuccess;
