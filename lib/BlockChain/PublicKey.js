...
class PublicKey
{
    ...
    constructor(raw)
    {
        // a flag indicating that this object is not complete and is
        // just initialized from an encoded public key
        this._local = raw.local !== undefined;
        this._name = raw.name;
