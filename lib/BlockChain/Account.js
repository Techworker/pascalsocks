...
class Account
{
    ...
    constructor(raw)
    {
        this._account = new AccountNumber(raw.account);
        ...
        if(raw.state === 'listed')
        {
            ...
            this._sellerAccount = new AccountNumber(raw.seller_account);
            this._privateSale = !!raw.private_sale;
            if(this._privateSale === true) {
                this._newEncPubKey = new HexaString(raw.new_enc_pubkey);
            }
        }
