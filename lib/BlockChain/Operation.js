...
class Operation
{
    ...
    static createFromRPC(rpc)
    {
        ...
        instance._signerAccountNumber = rpc.signer_account ? new AccountNumber(rpc.signer_account) : null;
        instance._signerAccount = null;
    ...
    /**
     * This will return a Map of all accounts which are somehow
    ...
    serialize()
    {
        ...
        return {
            ...
            block: this.block !== null ? this.block.serialize() : null,
            ...
            signerAccountNumber: this.signerAccountNumber !== null ? this.signerAccountNumber.toString() : null,
            signerAccount: this.signerAccount !== null ? this.signerAccount.serialize() : null,
            op_txt: this.opTxt,
