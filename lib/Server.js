...
class Server
{
     ...
     */
    constructor(config, eventMgr, clientManager, subscriptionManager, pascalRPCClient, chain, listener, chainLoader, channels)
    {
        ...
        channels.forEach((channel) => this.channels.set(channel.ident, channel));
